...
//            // assert
//            Assert.AreEqual(1, string_MyResult1, "User input is not valid, is not in database.");
//            Assert.AreEqual(0, string_MyResult1, "User input is valid, String is in database.");
//        }
